...
def get_pdf_content(url, page_nums=[0]):
    ...
    # information from your resume
        ...
        print bcolors.FAIL + "Error in get_pdf_content, Bad PDF link" + bcolors.ENDC
        return []
...
def get_pdf(url):
    ...
    try:
        ...
        if pdf_url == False:
            ...
            pdfSkills = list(tuple(set(pdfSkills).difference([' '])))
            pdfSkills = list(tuple(set(pdfSkills).difference([''])))
        return pdfSkills

    except:
        print bcolors.FAIL + "Error in Main func, get_pdf(). Bad HTML" + bcolors.ENDC
        return []
...
def get_html(url):
    try:
        ...
        try:
            ...
            print bcolors.FAIL + "Error in title_find" + bcolors.ENDC
            keywords_title = []
        ...
        try:
            ...
            print bcolors.FAIL + "Error in search_meta_keywords" + bcolors.ENDC
            keywords_meta = []
        ...
        try:
            ...
            print bcolors.FAIL + "Error in find_degree" + bcolors.ENDC
            keywords_degree = []
        ...
        keywords = list(tuple(set(keywords).difference([' '])))
        keywords = list(tuple(set(keywords).difference([''])))
        # except:
        # return "error"
        #print keywords
    ...
    # is an error
        ...
        print bcolors.FAIL + "Error in Main func, get_html(). Bad HTML." + bcolors.ENDC
        return []
